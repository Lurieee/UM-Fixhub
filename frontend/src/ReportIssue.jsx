...
export default function ReportIssue({ onBack, onSubmit, category: selectedCategory, report: existingReport }) {
  const category = existingReport?.category || selectedCategory || "Other";
